            ...
            <form action="<?php echo e(route('documents.update', $document->id)); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="original_filename" name="original_filename"
                        value="<?php echo e(old('original_filename', $document->original_filename)); ?>" required>
                    <?php $__errorArgs = ['original_filename'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control form-textarea" id="description" name="description" rows="3"><?php echo e(old('description', $document->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="file-info">
                    <strong>Tipe File:</strong> <?php echo e($document->file_mime_type ?? '-'); ?> <br>
                    <strong>Ukuran:</strong> <?php echo e(number_format($document->file_size / 1024, 2)); ?> KB <br>
                    <small>Tanggal Unggah: <?php echo e($document->created_at->format('d M Y H:i')); ?></small>
                </div>

                <button type="submit" class="btn btn-primary btn-update-doc">Simpan Perubahan</button>

                <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-secondary btn-update-doc mt-3">Batal</a>
            </form>
        </div>
...
</html><?php /**PATH C:\Users\THINKPAD\Documents\College\Pemmrograman Web\pemweb_project_akhir\docushare-pemweb\resources\views/edit.blade.php ENDPATH**/ ?>